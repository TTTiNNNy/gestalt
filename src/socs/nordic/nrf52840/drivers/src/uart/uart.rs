...
use gpio::gpio;
use self::nrf52840_peripheral_access::Peripherals;
use core::borrow::Borrow;
use self::gestalt_reference::interface::DMAGestaltInterface;
...
pub struct Uart
{
    pub base: *const nrf52840_peripheral_access::uarte0::RegisterBlock,
...
pub fn new	(inst: UartInst) -> Uart
{
    let i = Uart{base : ((inst as u32)
        as  *const nrf52840_peripheral_access::uarte0::RegisterBlock), write_type: Uart::dma_write};
    i
}
